...
const Footer = () => {
    return (
        <>
        <footer className="bg-black text-white w-full px-32 py-8">
            <div className="grid grid-cols-4 gap-8 leading-8 py-10 px-8">
                <div>
            ...
            <div className="flex justify-center space-x-8 pb-5">
