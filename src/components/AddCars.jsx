  ...
  return (
    <div className="bg-gray-800 p-4 rounded-lg shadow-sm">
      <section>
        ...
        <form
          className="form-container grid grid-cols-1 md:grid-cols-2 gap-3 mt-6"
        ...
        >
          {[
            ...
            <div key={field.id} className="col-span-1">
              ...
              <input
                type={field.type}
                className="p-2 block w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-green-500 focus:ring-green-500"
                id={field.id}
                name={field.id}
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <textarea
              className="block w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-green-500 focus:ring-green-500"
              rows="3"
              id="Description"
              name="Description"
