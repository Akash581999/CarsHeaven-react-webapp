...
const EditCars = () => {
  ...
  return (
    <div className="bg-gray-800 p-4 rounded-lg shadow-sm">
      <section>
        <span className="text-2xl text-yellow-500 font-bold">Edit Car</span>
        <form
          className="form-container grid grid-cols-1 md:grid-cols-2 gap-2 mt-6"
        ...
        >
          {[
            { id: "CarId", label: "Car Id", type: "text" },
