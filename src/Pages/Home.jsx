...
import png2 from "../assets/Pngs/van.png";
import png3 from "../assets/Pngs/minibus.png";
import png4 from "../assets/Pngs/sportscar.png";
        ...
        <div className="relative w-full h-screen bg-slate-500">
            ...
            <div className="absolute top-[20%] left-[15%] space-y-12 ">
                <h1 className="text-white font-semibold text-5xl">
                    Looking for a <span className="text-green-500">vehicle</span>? You are at the right place.
                </h1>
                <div className="w-[72vw] h-[36vh] bg-white grid grid-cols-2 gap-4 p-4 border rounded-md">
                    ...
                    <div className="col-span-1 flex flex-col justify-start gap-4">
                        ...
                        <div className="flex items-start justify-between">
                            <div className="h-24 w-32 bg-green-500 flex flex-col items-center justify-center p-2 rounded-lg">
                                <img src={png1} alt="Car Icon" className="h-12" />
                                <span>Car</span>
                            </div>
                            <div className="h-24 w-32 bg-green-500 flex flex-col items-center justify-center p-2 rounded-lg">
                                <img src={png2} alt="Van Icon" className="h-12" />
                                <span>Van</span>
                            </div>
                            <div className="h-24 w-32 bg-green-500 flex flex-col items-center justify-center p-2 rounded-lg">
                                <img src={png3} alt="Minibus Icon" className="h-12" />
                                <span>Minibus</span>
                            </div>
                            <div className="h-24 w-32 bg-green-500 flex flex-col items-center justify-center p-2 rounded-lg">
                                <img src={png4} alt="Prestige Icon" className="h-12" />
                                <span>Prestige</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-span-1 flex flex-col justify-start space-y-4">
                        <div className="flex gap-10 ">
                            <div className="w-full">
                                <label htmlFor="font-bold">Pick Up Location</label>
                                <input
                                    type="text"
                            ...
                            <div className="w-full">
                                <label htmlFor="font-bold">Drop Off Location</label>
                                <input
                                    type="text"
                        ...
                        <button className="bg-green-500 text-white p-2 rounded m-4 flex justify-center w-50">
                            Find a Vehicle
                        </button>
                    </div>
                </div>
                <div className="w-[72vw] h-[32vh] grid grid-cols-4 gap-4 p-4 mt-4">
                    {data.map((item, index) => (
                        <div
                            key={index}
                            className="flex flex-col items-left w-[13vw] justify-between text-white"
                        >
